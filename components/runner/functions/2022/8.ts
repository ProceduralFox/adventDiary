export const Day8First2022 = (input:string)=>{
  ...
  for (let rowIndex = 0; rowIndex < grid.length; rowIndex++) {
    ...
    for (let colIndex = 0; colIndex < row.length; colIndex++) {
      ...
      if(treeHeight>currentTallest){
        visibleTreeIndexes.add(`${rowIndex}-${colIndex}`)
  ...
  for (let columnIndex = 0; columnIndex < grid[0].length; columnIndex++) {
    ...
    for (let rowIndex = 0; rowIndex < grid.length; rowIndex++) {
      ...
      if(treeHeight>currentTallest){
        visibleTreeIndexes.add(`${rowIndex}-${columnIndex}`)
        currentTallest = treeHeight
      }
...
export const Day8Second2022 = (input:string)=>{
